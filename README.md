...
git clone https://github.com/YuvrajJha13/MLGuardian.gitcd MLGuardian# Install dependenciespip install -r requirements.txt# Build the C++ extensionpython setup.py build_ext --inplace